...
def home():
    ...
    with open('/BlockerCreate/output.html', 'r') as file:
        return file.read()
...
def executeFunction():
    ...
    create_draft_invitation(subject="Blocker for Ecosystem:",meeting_date=meeting_date,start_time=time_object,duration=timedelta(hours=1, minutes=5),attendees=attendees,optional_attendees=optional_attendees,body='')
